 ...
 * 
 */
@WebServiceClient(name = "MainService", targetNamespace = "http://service.lab.soa.agh.edu.pl/", wsdlLocation = "http://localhost:8080/Main/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MAINSERVICE_QNAME = new QName("http://service.lab.soa.agh.edu.pl/", "MainService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Main/?wsdl");
    ...
    public Main getMainPort() {
        return super.getPort(new QName("http://service.lab.soa.agh.edu.pl/", "MainPort"), Main.class);
    }
    ...
    public Main getMainPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.lab.soa.agh.edu.pl/", "MainPort"), Main.class, features);
    }
